...
class PlayerOptData;
struct PlayerOptDataDefaultTypeInternal;
extern PlayerOptDataDefaultTypeInternal _PlayerOptData_default_instance_;
class ServerInfo;
...
template<> ::Net::PlayerMessage* Arena::CreateMaybeMessage<::Net::PlayerMessage>(Arena*);
template<> ::Net::PlayerOptData* Arena::CreateMaybeMessage<::Net::PlayerOptData>(Arena*);
...
enum Frame_Send : int {
  Frame_Send_All = 0,
  Frame_Send_Single = 1,
  Frame_Send_Frame_Send_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Frame_Send_Frame_Send_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool Frame_Send_IsValid(int value);
constexpr Frame_Send Frame_Send_Send_MIN = Frame_Send_All;
constexpr Frame_Send Frame_Send_Send_MAX = Frame_Send_Single;
constexpr int Frame_Send_Send_ARRAYSIZE = Frame_Send_Send_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Frame_Send_descriptor();
template<typename T>
inline const std::string& Frame_Send_Name(T enum_t_value) {
  static_assert(::std::is_same<T, Frame_Send>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function Frame_Send_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    Frame_Send_descriptor(), enum_t_value);
}
inline bool Frame_Send_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, Frame_Send* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<Frame_Send>(
    Frame_Send_descriptor(), name, value);
}
enum PlayerOpt : int {
  Nothing = 0,
  A_Down = 21,
...
template<typename T>
inline const std::string& PlayerOpt_Name(T enum_t_value) {
  static_assert(::std::is_same<T, PlayerOpt>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function PlayerOpt_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    PlayerOpt_descriptor(), enum_t_value);
}
inline bool PlayerOpt_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, PlayerOpt* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<PlayerOpt>(
    PlayerOpt_descriptor(), name, value);
}
// ===================================================================
...
class PlayerOptData final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Net.PlayerOptData) */ {
 public:
  inline PlayerOptData() : PlayerOptData(nullptr) {}
  ~PlayerOptData() override;
  explicit constexpr PlayerOptData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  PlayerOptData(const PlayerOptData& from);
  PlayerOptData(PlayerOptData&& from) noexcept
    : PlayerOptData() {
    *this = ::std::move(from);
  }

  inline PlayerOptData& operator=(const PlayerOptData& from) {
    CopyFrom(from);
    return *this;
  }
  inline PlayerOptData& operator=(PlayerOptData&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const PlayerOptData& default_instance() {
    return *internal_default_instance();
  }
  static inline const PlayerOptData* internal_default_instance() {
    return reinterpret_cast<const PlayerOptData*>(
               &_PlayerOptData_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    8;

  friend void swap(PlayerOptData& a, PlayerOptData& b) {
    a.Swap(&b);
  }
  inline void Swap(PlayerOptData* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(PlayerOptData* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  PlayerOptData* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<PlayerOptData>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const PlayerOptData& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const PlayerOptData& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(PlayerOptData* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Net.PlayerOptData";
  }
  protected:
  explicit PlayerOptData(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  // .Net.PlayerOpt opt = 1;
  void clear_opt();
  ::Net::PlayerOpt opt() const;
  void set_opt(::Net::PlayerOpt value);
  private:
  ::Net::PlayerOpt _internal_opt() const;
  void _internal_set_opt(::Net::PlayerOpt value);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Net.PlayerOptData)
 private:
  class _Internal;
...
class PlayerMessage final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Net.PlayerMessage) */ {
 public:
  inline PlayerMessage() : PlayerMessage(nullptr) {}
  ~PlayerMessage() override;
  explicit constexpr PlayerMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  PlayerMessage(const PlayerMessage& from);
  PlayerMessage(PlayerMessage&& from) noexcept
    : PlayerMessage() {
    *this = ::std::move(from);
  }
  ...
  static inline const PlayerMessage* internal_default_instance() {
  ...
  friend void swap(PlayerMessage& a, PlayerMessage& b) {
    a.Swap(&b);
  }
  inline void Swap(PlayerMessage* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(PlayerMessage* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  PlayerMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<PlayerMessage>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(PlayerMessage* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Net.PlayerMessage";
  }
  protected:
  explicit PlayerMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  // @@protoc_insertion_point(class_scope:Net.PlayerMessage)
 private:
  class _Internal;
...
class Frame final :
 ...
 public:
  ...
  typedef Frame_Send Send;
  static constexpr Send All =
    Frame_Send_All;
  static constexpr Send Single =
    Frame_Send_Single;
  static inline bool Send_IsValid(int value) {
    return Frame_Send_IsValid(value);
  }
  static constexpr Send Send_MIN =
    Frame_Send_Send_MIN;
  static constexpr Send Send_MAX =
    Frame_Send_Send_MAX;
  static constexpr int Send_ARRAYSIZE =
    Frame_Send_Send_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  Send_descriptor() {
    return Frame_Send_descriptor();
  }
  template<typename T>
  static inline const std::string& Send_Name(T enum_t_value) {
    static_assert(::std::is_same<T, Send>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function Send_Name.");
    return Frame_Send_Name(enum_t_value);
  }
  static inline bool Send_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      Send* value) {
    return Frame_Send_Parse(name, value);
  }
  ...
  enum : int {
    ...
    kRoomidFieldNumber = 1,
    kIndexFieldNumber = 2,
    kSendcaseFieldNumber = 5,
    kUseridFieldNumber = 6,
  };
  // repeated .Net.PlayerOptData opts = 3;
  int opts_size() const;
  private:
  int _internal_opts_size() const;
  public:
  void clear_opts();
  ::Net::PlayerOptData* mutable_opts(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Net::PlayerOptData >*
      mutable_opts();
  private:
  const ::Net::PlayerOptData& _internal_opts(int index) const;
  ::Net::PlayerOptData* _internal_add_opts();
  public:
  const ::Net::PlayerOptData& opts(int index) const;
  ::Net::PlayerOptData* add_opts();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Net::PlayerOptData >&
      opts() const;

  // repeated .Net.PlayerMessage msgs = 4;
  int msgs_size() const;
  private:
  int _internal_msgs_size() const;
  public:
  void clear_msgs();
  ::Net::PlayerMessage* mutable_msgs(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Net::PlayerMessage >*
      mutable_msgs();
  private:
  const ::Net::PlayerMessage& _internal_msgs(int index) const;
  ::Net::PlayerMessage* _internal_add_msgs();
  public:
  const ::Net::PlayerMessage& msgs(int index) const;
  ::Net::PlayerMessage* add_msgs();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Net::PlayerMessage >&
      msgs() const;
  ...
  // .Net.Frame.Send sendcase = 5;
  void clear_sendcase();
  ::Net::Frame_Send sendcase() const;
  void set_sendcase(::Net::Frame_Send value);
  private:
  ::Net::Frame_Send _internal_sendcase() const;
  void _internal_set_sendcase(::Net::Frame_Send value);
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Net::PlayerOptData > opts_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Net::PlayerMessage > msgs_;
  int32_t roomid_;
  int32_t index_;
  int sendcase_;
  int32_t userid_;
...
inline const std::string& LoginResponse::username() const {
  // @@protoc_insertion_point(field_get:Net.LoginResponse.username)
  return _internal_username();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LoginResponse::set_username(ArgT0&& arg0, ArgT... args) {
 ...
 username_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Net.LoginResponse.username)
}
inline std::string* LoginResponse::mutable_username() {
  std::string* _s = _internal_mutable_username();
  // @@protoc_insertion_point(field_mutable:Net.LoginResponse.username)
  return _s;
}
...
inline std::string* LoginResponse::release_username() {
  // @@protoc_insertion_point(field_release:Net.LoginResponse.username)
  return username_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Net.LoginResponse.username)
}
...
inline int32_t CharacterData::_internal_userid() const {
  return userid_;
}
inline int32_t CharacterData::userid() const {
  // @@protoc_insertion_point(field_get:Net.CharacterData.userid)
  return _internal_userid();
}
inline void CharacterData::_internal_set_userid(int32_t value) {
  
  userid_ = value;
}
inline void CharacterData::set_userid(int32_t value) {
  _internal_set_userid(value);
...
inline int32_t UserMoney::_internal_userid() const {
  return userid_;
}
inline int32_t UserMoney::userid() const {
  // @@protoc_insertion_point(field_get:Net.UserMoney.userid)
  return _internal_userid();
}
inline void UserMoney::_internal_set_userid(int32_t value) {
  
  userid_ = value;
}
inline void UserMoney::set_userid(int32_t value) {
  _internal_set_userid(value);
...
// .Net.PlayerOpt opt = 1;
inline void PlayerOptData::clear_opt() {
  opt_ = 0;
}
inline ::Net::PlayerOpt PlayerOptData::_internal_opt() const {
  return static_cast< ::Net::PlayerOpt >(opt_);
}
inline ::Net::PlayerOpt PlayerOptData::opt() const {
  // @@protoc_insertion_point(field_get:Net.PlayerOptData.opt)
  return _internal_opt();
}
inline void PlayerOptData::_internal_set_opt(::Net::PlayerOpt value) {
  
  opt_ = value;
}
inline void PlayerOptData::set_opt(::Net::PlayerOpt value) {
  _internal_set_opt(value);
  // @@protoc_insertion_point(field_set:Net.PlayerOptData.opt)
}

// int32 userid = 2;
inline void PlayerOptData::clear_userid() {
  userid_ = 0;
}
inline int32_t PlayerOptData::_internal_userid() const {
  return userid_;
}
inline int32_t PlayerOptData::userid() const {
  // @@protoc_insertion_point(field_get:Net.PlayerOptData.userid)
  return _internal_userid();
}
inline void PlayerOptData::_internal_set_userid(int32_t value) {
  
  userid_ = value;
}
inline void PlayerOptData::set_userid(int32_t value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:Net.PlayerOptData.userid)
}

// int32 roomid = 3;
inline void PlayerOptData::clear_roomid() {
  roomid_ = 0;
}
inline int32_t PlayerOptData::_internal_roomid() const {
  return roomid_;
}
inline int32_t PlayerOptData::roomid() const {
  // @@protoc_insertion_point(field_get:Net.PlayerOptData.roomid)
  return _internal_roomid();
}
inline void PlayerOptData::_internal_set_roomid(int32_t value) {
  
  roomid_ = value;
}
inline void PlayerOptData::set_roomid(int32_t value) {
  _internal_set_roomid(value);
  // @@protoc_insertion_point(field_set:Net.PlayerOptData.roomid)
}

// int32 itemid = 4;
inline void PlayerOptData::clear_itemid() {
  itemid_ = 0;
}
inline int32_t PlayerOptData::_internal_itemid() const {
  return itemid_;
}
inline int32_t PlayerOptData::itemid() const {
  // @@protoc_insertion_point(field_get:Net.PlayerOptData.itemid)
  return _internal_itemid();
}
inline void PlayerOptData::_internal_set_itemid(int32_t value) {
  
  itemid_ = value;
}
inline void PlayerOptData::set_itemid(int32_t value) {
  _internal_set_itemid(value);
  // @@protoc_insertion_point(field_set:Net.PlayerOptData.itemid)
}
...
// int32 roomid = 1;
inline void PlayerMessage::clear_roomid() {
  roomid_ = 0;
}
inline int32_t PlayerMessage::_internal_roomid() const {
  return roomid_;
}
inline int32_t PlayerMessage::roomid() const {
  // @@protoc_insertion_point(field_get:Net.PlayerMessage.roomid)
  return _internal_roomid();
}
inline void PlayerMessage::_internal_set_roomid(int32_t value) {
  
  roomid_ = value;
}
inline void PlayerMessage::set_roomid(int32_t value) {
  _internal_set_roomid(value);
  // @@protoc_insertion_point(field_set:Net.PlayerMessage.roomid)
}

// int32 userid = 2;
inline void PlayerMessage::clear_userid() {
  userid_ = 0;
}
inline int32_t PlayerMessage::_internal_userid() const {
  return userid_;
}
inline int32_t PlayerMessage::userid() const {
  // @@protoc_insertion_point(field_get:Net.PlayerMessage.userid)
  return _internal_userid();
}
inline void PlayerMessage::_internal_set_userid(int32_t value) {
  
  userid_ = value;
}
inline void PlayerMessage::set_userid(int32_t value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:Net.PlayerMessage.userid)
}

// string content = 3;
inline void PlayerMessage::clear_content() {
  content_.ClearToEmpty();
}
inline const std::string& PlayerMessage::content() const {
  // @@protoc_insertion_point(field_get:Net.PlayerMessage.content)
  return _internal_content();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PlayerMessage::set_content(ArgT0&& arg0, ArgT... args) {
 ...
 content_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Net.PlayerMessage.content)
}
inline std::string* PlayerMessage::mutable_content() {
  std::string* _s = _internal_mutable_content();
  // @@protoc_insertion_point(field_mutable:Net.PlayerMessage.content)
  return _s;
}
inline const std::string& PlayerMessage::_internal_content() const {
  return content_.Get();
}
inline void PlayerMessage::_internal_set_content(const std::string& value) {
  
  content_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* PlayerMessage::_internal_mutable_content() {
  
  return content_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* PlayerMessage::release_content() {
  // @@protoc_insertion_point(field_release:Net.PlayerMessage.content)
  return content_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void PlayerMessage::set_allocated_content(std::string* content) {
  if (content != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Net.PlayerMessage.content)
}
...
// int32 roomid = 1;
inline void Frame::clear_roomid() {
  roomid_ = 0;
}
inline int32_t Frame::_internal_roomid() const {
  return roomid_;
}
inline int32_t Frame::roomid() const {
  // @@protoc_insertion_point(field_get:Net.Frame.roomid)
  return _internal_roomid();
}
inline void Frame::_internal_set_roomid(int32_t value) {
  
  roomid_ = value;
}
inline void Frame::set_roomid(int32_t value) {
  _internal_set_roomid(value);
  // @@protoc_insertion_point(field_set:Net.Frame.roomid)
}
...
inline int32_t Frame::index() const {
  // @@protoc_insertion_point(field_get:Net.Frame.index)
...
inline void Frame::set_index(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:Net.Frame.index)
}

// repeated .Net.PlayerOptData opts = 3;
inline int Frame::_internal_opts_size() const {
  return opts_.size();
}
inline int Frame::opts_size() const {
  return _internal_opts_size();
}
inline void Frame::clear_opts() {
  opts_.Clear();
}
inline ::Net::PlayerOptData* Frame::mutable_opts(int index) {
  // @@protoc_insertion_point(field_mutable:Net.Frame.opts)
  return opts_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Net::PlayerOptData >*
Frame::mutable_opts() {
  // @@protoc_insertion_point(field_mutable_list:Net.Frame.opts)
  return &opts_;
}
inline const ::Net::PlayerOptData& Frame::_internal_opts(int index) const {
  return opts_.Get(index);
}
inline const ::Net::PlayerOptData& Frame::opts(int index) const {
  // @@protoc_insertion_point(field_get:Net.Frame.opts)
  return _internal_opts(index);
}
inline ::Net::PlayerOptData* Frame::_internal_add_opts() {
  return opts_.Add();
}
inline ::Net::PlayerOptData* Frame::add_opts() {
  ::Net::PlayerOptData* _add = _internal_add_opts();
  // @@protoc_insertion_point(field_add:Net.Frame.opts)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Net::PlayerOptData >&
Frame::opts() const {
  // @@protoc_insertion_point(field_list:Net.Frame.opts)
  return opts_;
}

// repeated .Net.PlayerMessage msgs = 4;
inline int Frame::_internal_msgs_size() const {
  return msgs_.size();
}
inline int Frame::msgs_size() const {
  return _internal_msgs_size();
}
inline void Frame::clear_msgs() {
  msgs_.Clear();
}
inline ::Net::PlayerMessage* Frame::mutable_msgs(int index) {
  // @@protoc_insertion_point(field_mutable:Net.Frame.msgs)
  return msgs_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Net::PlayerMessage >*
Frame::mutable_msgs() {
  // @@protoc_insertion_point(field_mutable_list:Net.Frame.msgs)
  return &msgs_;
}
inline const ::Net::PlayerMessage& Frame::_internal_msgs(int index) const {
  return msgs_.Get(index);
}
inline const ::Net::PlayerMessage& Frame::msgs(int index) const {
  // @@protoc_insertion_point(field_get:Net.Frame.msgs)
  return _internal_msgs(index);
}
inline ::Net::PlayerMessage* Frame::_internal_add_msgs() {
  return msgs_.Add();
}
inline ::Net::PlayerMessage* Frame::add_msgs() {
  ::Net::PlayerMessage* _add = _internal_add_msgs();
  // @@protoc_insertion_point(field_add:Net.Frame.msgs)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Net::PlayerMessage >&
Frame::msgs() const {
  // @@protoc_insertion_point(field_list:Net.Frame.msgs)
  return msgs_;
}

// .Net.Frame.Send sendcase = 5;
inline void Frame::clear_sendcase() {
  sendcase_ = 0;
}
inline ::Net::Frame_Send Frame::_internal_sendcase() const {
  return static_cast< ::Net::Frame_Send >(sendcase_);
}
inline ::Net::Frame_Send Frame::sendcase() const {
  // @@protoc_insertion_point(field_get:Net.Frame.sendcase)
  return _internal_sendcase();
}
inline void Frame::_internal_set_sendcase(::Net::Frame_Send value) {
  
  sendcase_ = value;
}
inline void Frame::set_sendcase(::Net::Frame_Send value) {
  _internal_set_sendcase(value);
  // @@protoc_insertion_point(field_set:Net.Frame.sendcase)
}

// int32 userid = 6;
inline void Frame::clear_userid() {
  userid_ = 0;
}
inline int32_t Frame::_internal_userid() const {
  return userid_;
}
inline int32_t Frame::userid() const {
  // @@protoc_insertion_point(field_get:Net.Frame.userid)
  return _internal_userid();
}
inline void Frame::_internal_set_userid(int32_t value) {
  
  userid_ = value;
}
inline void Frame::set_userid(int32_t value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:Net.Frame.userid)
}
...
template <> struct is_proto_enum< ::Net::Frame_Send> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Net::Frame_Send>() {
  return ::Net::Frame_Send_descriptor();
}
template <> struct is_proto_enum< ::Net::PlayerOpt> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Net::PlayerOpt>() {
  return ::Net::PlayerOpt_descriptor();
}
